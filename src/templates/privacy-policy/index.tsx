    ...
    <Page.Container>
      <div className="flex flex-col h-full gap-md max-w-centered-content mx-auto box-border overflow-auto scrollbar p-lg">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to MDS TECH CONSULTORIA EM TECNOLOGIA DA
              INFORMACAO LTDA, 212 Bom Jesus Street, Room 1904.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Profile Readme Generator,
              accessible from{' '}
              <a
                href="https://profile-readme-generator.com"
        ...
        <p>
          ...
          interactions with advertisements and optimize ad targeting. Please
          note that disabling cookies may limit access to certain content and
          features on the website, and rejecting cookies does not eliminate
          advertisements but will result in non-personalized advertising. You
          can find more information about cookies and how to manage them{' '}
          <a
        ...
        <p>
          ...
          advertisements across various platforms and websites. Ezoic&quot;s
          partners may also gather additional data, such as unique IDs,
          advertising IDs, geolocation data, usage data, device information,
          traffic data, referral sources, and interactions between users and
          websites or advertisements, to create audience segments for targeted
          advertising across different devices, browsers, and apps. You can find
          more information about interest-based advertising and how to manage
          them{' '}
